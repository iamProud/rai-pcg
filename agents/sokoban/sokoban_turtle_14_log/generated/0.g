...
robo (worldTranslationRotation) 	{  Q:[-3.5, -1.5, 0.05, -1, 0, 0, 0] }
...
goal2-8 (floor) 	{  Q:[-3.5, 2.5, 0.051, -1, 0, 0, 0], shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], color:[0, 1, 0] }
goal2-9 (floor) 	{  Q:[-3.5, 3.5, 0.051, -1, 0, 0, 0], shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], color:[0, 1, 0] }
