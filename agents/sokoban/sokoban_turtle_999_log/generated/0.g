...
robo (roboJoint) 	{  Q:[2.5, 0.5, 0, -1, 0, 0, 0], joint:transXY, limits:[-10, 10, -10, 10], shape:ssCylinder, size:[0.2, 0.2, 0.02], color:[0.96875, 0.742188, 0.308594], contact:1, logical:{ is_gripper }, sampleUniform:1 }
...
goal8-2 (floor) 	{  Q:[3.5, -2.5, 0.051, -1, 0, 0, 0], shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], color:[0, 1, 0] }
