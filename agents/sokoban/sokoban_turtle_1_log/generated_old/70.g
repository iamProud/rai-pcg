...
box2-7 (world) 	{  Q:[-4, 1, 0.5, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[0.5, 0.5, 1, 0.02], contact:-1 }
...
goal3-8 (world) 	{  Q:[-3, 2, 0.001, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], contact:-1 }
