world 	{  }
robo (worldTranslationRotation) 	{  Q:[-2, -3, 0, -1, 0, 0, 0] }
...
goal2-9 (world) 	{  Q:[-4, 3, 0.001, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], contact:-1 }
...
box7-4 (world) 	{  Q:[1, -2, 0.5, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[0.5, 0.5, 1, 0.02], contact:-1 }
