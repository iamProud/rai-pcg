...
roboJoint (world) 	{  }
robo (roboJoint) 	{  Q:[2.5, 4.5, 0, -1, 0, 0, 0], joint:transXY, limits:[-10, 10, -10, 10] }
...
box10-7 (floor) 	{  Q:[4.5, 1.5, 0.55, -1, 0, 0, 0], shape:ssBox, size:[0.5, 0.5, 1, 0.02], color:[0.6, 0.3, 0] }
