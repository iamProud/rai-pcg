...
robo (worldTranslationRotation) 	{  Q:[-0.5, 1.5, 0.05, -1, 0, 0, 0] }
...
goal7-5 (floor) 	{  Q:[1.5, -0.5, 0.051, -1, 0, 0, 0], shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], color:[0, 1, 0] }
...
box9-4 (floor) 	{  Q:[3.5, -1.5, 0.55, -1, 0, 0, 0], shape:ssBox, size:[0.5, 0.5, 1, 0.02], color:[0.6, 0.3, 0] }
