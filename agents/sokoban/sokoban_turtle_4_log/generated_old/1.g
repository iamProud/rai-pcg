world 	{  }
robo (worldTranslationRotation) 	{  Q:[1, 3, 0, -1, 0, 0, 0] }
...
box3-3 (world) 	{  Q:[-3, -3, 0.5, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[0.5, 0.5, 1, 0.02], contact:-1 }
...
block3-9 (world) 	{  Q:[-3, 3, 0.5, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[1, 1, 1, 0.02], contact:1, mass:100 }
goal3-10 (world) 	{  Q:[-3, 4, 0.001, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], contact:-1 }
...
goal9-1 (world) 	{  Q:[3, -5, 0.001, -1, 0, 0, 0], joint:rigid, shape:ssBox, size:[0.95, 0.95, 0.004, 0.002], contact:-1 }
